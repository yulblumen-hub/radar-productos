...
const RUBROS_META = [
  { n:"Comederos y bebederos", cat:"Mascotas", temp:"todo el año", margen:62, explotado:55, proyeccion:88, tend:"subiendo", term:"宠物碗", nota:"Ancla clásica: problema visible y demo perfecta." },
  { n:"Juguetes para perro", cat:"Mascotas", temp:"todo el año", margen:58, explotado:62, proyeccion:80, tend:"estable", term:"狗玩具", nota:"Recompra por desgaste. Cuidado con la calidad." },
  { n:"Juguetes para gato", cat:"Mascotas", temp:"todo el año", margen:64, explotado:48, proyeccion:83, tend:"subiendo", term:"猫玩具", nota:"Menos saturado que perro y el dueño gasta igual." },
  { n:"Cepillado y pelo de mascota", cat:"Mascotas", temp:"todo el año", margen:66, explotado:44, proyeccion:86, tend:"subiendo", term:"宠物梳", nota:"El antes/después es contenido viral asegurado." },
  { n:"Correas y arneses", cat:"Mascotas", temp:"todo el año", margen:58, explotado:66, proyeccion:74, tend:"estable", term:"宠物牵引绳", nota:"Muy competido, pero el arnés antitirón todavía rinde." },
  { n:"Higiene de mascota", cat:"Mascotas", temp:"todo el año", margen:52, explotado:40, proyeccion:82, tend:"subiendo", term:"宠物清洁", nota:"Bolsitas y toallitas: el motor de recompra del rubro." },
  { n:"Transporte de mascota", cat:"Mascotas", temp:"todo el año", margen:48, explotado:42, proyeccion:78, tend:"subiendo", term:"宠物背包", nota:"Voluminoso: calcular el flete antes de enamorarse." },
  { n:"Camas y descanso de mascota", cat:"Mascotas", temp:"invierno", margen:44, explotado:58, proyeccion:70, tend:"estable", term:"宠物窝", nota:"Volumen alto, margen bajo por flete." },
  { n:"Ropa para mascota", cat:"Mascotas", temp:"invierno", margen:50, explotado:70, proyeccion:62, tend:"bajando", term:"宠物衣服", nota:"Tiene talles: el clavo del rubro." },
  { n:"Fuentes de agua para gatos", cat:"Mascotas", temp:"verano", margen:54, explotado:35, proyeccion:84, tend:"subiendo", term:"猫饮水机", nota:"Nicho en crecimiento. Enchufa: revisar certificación." },
  { n:"Masajeadores de cuello", cat:"Wellness", temp:"invierno", margen:74, explotado:45, proyeccion:88, tend:"subiendo", term:"颈椎按摩器", nota:"Demo hipnótica, ticket alto, regalo perfecto." },
  { n:"Pistolas de masaje", cat:"Wellness", temp:"invierno", margen:70, explotado:52, proyeccion:82, tend:"estable", term:"筋膜枪", nota:"Costo bajo y ticket alto. Gimnasio y oficina." },
  { n:"Difusores y humidificadores", cat:"Wellness", temp:"invierno", margen:72, explotado:55, proyeccion:74, tend:"estable", term:"香薰加湿器", nota:"Video precioso y recompra por esencias." },
  { n:"Almohadas ergonómicas", cat:"Wellness", temp:"invierno", margen:68, explotado:42, proyeccion:85, tend:"subiendo", term:"记忆棉枕头", nota:"Dolor real: se paga sin discutir." },
  { n:"Antiestrés y foco", cat:"Wellness", temp:"todo el año", margen:72, explotado:30, proyeccion:79, tend:"subiendo", term:"减压玩具", nota:"Impulso puro y contenido que se comparte." },
  { n:"Sueño y descanso", cat:"Wellness", temp:"invierno", margen:70, explotado:38, proyeccion:80, tend:"subiendo", term:"助眠用品", nota:"Antifaces, ruido blanco. Nicho creciendo fuerte." },
  { n:"Corrección postural", cat:"Salud", temp:"invierno", margen:74, explotado:38, proyeccion:84, tend:"subiendo", term:"背部矫正带", nota:"Demo clara. Cuidado con promesas médicas." },
  { n:"Soporte lumbar y cervical", cat:"Salud", temp:"invierno", margen:72, explotado:40, proyeccion:80, tend:"estable", term:"护腰带", nota:"Público de trabajo físico, alta intención." },
  { n:"Movilidad y bastones", cat:"Salud", temp:"todo el año", margen:66, explotado:28, proyeccion:76, tend:"subiendo", term:"助行器", nota:"Adultos mayores: nicho enorme y desatendido." },
  { n:"Compresión y circulación", cat:"Salud", temp:"otoño", margen:64, explotado:44, proyeccion:74, tend:"estable", term:"压缩袜", nota:"Recompra natural. Verificar si es producto médico." },
  { n:"Botiquín y primeros auxilios", cat:"Salud", temp:"otoño", margen:52, explotado:50, proyeccion:66, tend:"estable", term:"急救包", nota:"Compra por miedo. Ticket bajo, va en kit." },
  { n:"Termómetros y medición", cat:"Salud", temp:"todo el año", margen:44, explotado:58, proyeccion:60, tend:"bajando", term:"体温计", nota:"Puede caer en producto médico: verificar." },
  { n:"Organización de cocina", cat:"Hogar", temp:"todo el año", margen:56, explotado:72, proyeccion:74, tend:"estable", term:"厨房收纳", nota:"Rey del video demo. Recompra baja." },
  { n:"Utensilios multifunción", cat:"Hogar", temp:"todo el año", margen:52, explotado:76, proyeccion:68, tend:"bajando", term:"多功能厨房工具", nota:"Saturadísimo: sólo con ángulo propio." },
  { n:"Termos y botellas", cat:"Hogar", temp:"invierno", margen:64, explotado:60, proyeccion:82, tend:"subiendo", term:"保温杯", nota:"Muy argentino. La pantalla de temperatura es el gancho." },
  { n:"Mate y accesorios", cat:"Hogar", temp:"invierno", margen:70, explotado:50, proyeccion:88, tend:"subiendo", term:"—", nota:"Demanda local enorme. Personalización = margen." },
  { n:"Cafetería en casa", cat:"Hogar", temp:"invierno", margen:58, explotado:48, proyeccion:80, tend:"subiendo", term:"咖啡器具", nota:"Comunidad apasionada, ticket alto, consumibles." },
  { n:"Organización de placard", cat:"Hogar", temp:"primavera", margen:56, explotado:64, proyeccion:72, tend:"estable", term:"衣柜收纳", nota:"Set que sube el ticket. Demo simple." },
  { n:"Baño y orden", cat:"Hogar", temp:"todo el año", margen:56, explotado:62, proyeccion:68, tend:"estable", term:"浴室收纳", nota:"Ticket bajo: obligado a vender en combo." },
  { n:"Limpieza y aspirado", cat:"Hogar", temp:"todo el año", margen:56, explotado:55, proyeccion:78, tend:"subiendo", term:"手持吸尘器", nota:"Antes/después imbatible. Enchufa." },
  { n:"Quitapelusas y textil", cat:"Hogar", temp:"todo el año", margen:56, explotado:45, proyeccion:74, tend:"subiendo", term:"去毛球器", nota:"Modelo maquinita y hojita." },
  { n:"Repuestos y consumibles hogar", cat:"Hogar", temp:"todo el año", margen:56, explotado:35, proyeccion:80, tend:"subiendo", term:"清洁替换", nota:"Lo que hace que vuelvan sin pagar ads." },
  { n:"Deco de pared", cat:"Hogar", temp:"todo el año", margen:60, explotado:68, proyeccion:62, tend:"estable", term:"墙面装饰", nota:"Muy visual pero frágil en tránsito." },
  { n:"Iluminación LED deco", cat:"Hogar", temp:"todo el año", margen:52, explotado:58, proyeccion:66, tend:"estable", term:"LED灯带", nota:"Barato de pautar. Enchufa: certificación." },
  { n:"Velas y aromas", cat:"Hogar", temp:"invierno", margen:66, explotado:64, proyeccion:60, tend:"bajando", term:"香薰蜡烛", nota:"Recompra buena, pero flete y rotura." },
  { n:"Plantas y macetas", cat:"Jardín", temp:"verano", margen:62, explotado:40, proyeccion:72, tend:"subiendo", term:"花盆", nota:"Nicho apasionado, poco explotado acá." },
  { n:"Riego automático", cat:"Jardín", temp:"verano", margen:66, explotado:30, proyeccion:82, tend:"subiendo", term:"自动滴灌", nota:"Resuelve irse de vacaciones. Muy poco explotado." },
  { n:"Herramientas de jardín", cat:"Jardín", temp:"primavera", margen:56, explotado:42, proyeccion:70, tend:"estable", term:"园艺工具", nota:"Alta intención, cero devolución." },
  { n:"Huerta en casa", cat:"Jardín", temp:"verano", margen:60, explotado:32, proyeccion:76, tend:"subiendo", term:"种植箱", nota:"Tendencia sostenida post pandemia." },
  { n:"Setup de escritorio", cat:"Oficina", temp:"otoño", margen:62, explotado:52, proyeccion:82, tend:"subiendo", term:"桌面收纳", nota:"Compran por estética. Marca propia fácil." },
  { n:"Soportes y ergonomía", cat:"Oficina", temp:"otoño", margen:64, explotado:48, proyeccion:84, tend:"subiendo", term:"笔记本支架", nota:"Liviano, sin variantes, ticket medio." },
  { n:"Cables y organización", cat:"Oficina", temp:"otoño", margen:54, explotado:70, proyeccion:62, tend:"estable", term:"理线器", nota:"Satélite ideal, nunca ancla." },
  { n:"Papelería premium", cat:"Oficina", temp:"otoño", margen:44, explotado:58, proyeccion:58, tend:"bajando", term:"文具", nota:"Ticket bajo y estacional." },
  { n:"Sillas y apoyos", cat:"Oficina", temp:"todo el año", margen:44, explotado:55, proyeccion:70, tend:"estable", term:"人体工学", nota:"Voluminoso: flete caro." },
  { n:"Iluminación de escritorio", cat:"Oficina", temp:"otoño", margen:48, explotado:56, proyeccion:68, tend:"estable", term:"台灯", nota:"Enchufa: seguridad eléctrica sí o sí." },
  { n:"Organizadores de auto", cat:"Auto", temp:"todo el año", margen:56, explotado:50, proyeccion:82, tend:"subiendo", term:"车载收纳", nota:"Utilidad pura, público masivo." },
  { n:"Soportes de celular auto", cat:"Auto", temp:"todo el año", margen:50, explotado:72, proyeccion:66, tend:"bajando", term:"车载手机支架", nota:"Impulso puro, ticket bajo." },
  { n:"Limpieza de auto", cat:"Auto", temp:"verano", margen:60, explotado:48, proyeccion:78, tend:"subiendo", term:"洗车用品", nota:"Antes/después + consumible que se repone." },
  { n:"Seguridad y emergencia auto", cat:"Auto", temp:"todo el año", margen:62, explotado:40, proyeccion:74, tend:"subiendo", term:"车用应急", nota:"Compra por miedo, alta conversión." },
  { n:"Confort en auto", cat:"Auto", temp:"verano", margen:56, explotado:52, proyeccion:72, tend:"estable", term:"汽车座椅垫", nota:"Cuidado con compatibilidad por modelo." },
  { n:"Accesorios de moto", cat:"Auto", temp:"todo el año", margen:56, explotado:44, proyeccion:76, tend:"subiendo", term:"摩托车配件", nota:"Comunidad fiel y muy segmentable." },
  { n:"Camping y refugio", cat:"Outdoor", temp:"verano", margen:58, explotado:40, proyeccion:79, tend:"subiendo", term:"户外露营", nota:"Ticket alto, comunidad fiel, estacional." },
  { n:"Cocina outdoor", cat:"Outdoor", temp:"verano", margen:58, explotado:38, proyeccion:78, tend:"subiendo", term:"户外炊具", nota:"Asado + camping: combinación muy argentina." },
  { n:"Mochilas técnicas", cat:"Outdoor", temp:"verano", margen:50, explotado:55, proyeccion:76, tend:"estable", term:"户外背包", nota:"Ticket alto. Textil paga derechos altos." },
  { n:"Hidratación outdoor", cat:"Outdoor", temp:"verano", margen:58, explotado:45, proyeccion:74, tend:"subiendo", term:"户外水壶", nota:"Liviano y fácil de brandear." },
  { n:"Pesca", cat:"Outdoor", temp:"verano", margen:58, explotado:35, proyeccion:72, tend:"estable", term:"钓鱼用品", nota:"Nicho apasionado que gasta sin mirar." },
  { n:"Ciclismo accesorios", cat:"Outdoor", temp:"verano", margen:58, explotado:58, proyeccion:74, tend:"subiendo", term:"自行车配件", nota:"Creciendo con la movilidad urbana." },
  { n:"Trekking y montaña", cat:"Outdoor", temp:"verano", margen:58, explotado:42, proyeccion:70, tend:"estable", term:"登山装备", nota:"Estacional pero de ticket alto." },
  { n:"Bandas y resistencia", cat:"Fitness", temp:"primavera", margen:62, explotado:68, proyeccion:70, tend:"estable", term:"阻力带", nota:"Liviano, sin certificación, se vende en kit." },
  { n:"Core y abdominales", cat:"Fitness", temp:"primavera", margen:62, explotado:70, proyeccion:64, tend:"bajando", term:"健腹轮", nota:"Muy competido por precio." },
  { n:"Yoga y pilates", cat:"Fitness", temp:"primavera", margen:62, explotado:60, proyeccion:72, tend:"estable", term:"瑜伽用品", nota:"Público que recompra por nivel." },
  { n:"Recuperación muscular", cat:"Fitness", temp:"primavera", margen:68, explotado:44, proyeccion:80, tend:"subiendo", term:"筋膜球", nota:"Cruza con Wellness: ticket alto." },
  { n:"Medición y wearables", cat:"Fitness", temp:"primavera", margen:34, explotado:75, proyeccion:58, tend:"bajando", term:"运动手环", nota:"Competís contra marcas conocidas." },
  { n:"Accesorios de gimnasio", cat:"Fitness", temp:"primavera", margen:58, explotado:62, proyeccion:66, tend:"estable", term:"健身配件", nota:"Guantes, straps, muñequeras. Satélites." },
  { n:"Cochecitos y accesorios", cat:"Bebés", temp:"todo el año", margen:60, explotado:50, proyeccion:84, tend:"subiendo", term:"婴儿车配件", nota:"Compran sin regatear." },
  { n:"Alimentación de bebé", cat:"Bebés", temp:"todo el año", margen:60, explotado:52, proyeccion:80, tend:"subiendo", term:"婴儿餐具", nota:"Recompra por etapas." },
  { n:"Seguridad del hogar bebé", cat:"Bebés", temp:"todo el año", margen:60, explotado:44, proyeccion:82, tend:"subiendo", term:"儿童安全", nota:"Compra por miedo: convierte altísimo." },
  { n:"Baño y cambiado", cat:"Bebés", temp:"todo el año", margen:60, explotado:48, proyeccion:76, tend:"estable", term:"婴儿洗浴", nota:"Recompra buena, ticket medio." },
  { n:"Juguetes de estimulación", cat:"Bebés", temp:"todo el año", margen:60, explotado:56, proyeccion:74, tend:"estable", term:"婴儿玩具", nota:"Certificación de juguetes obligatoria." },
  { n:"Porteo", cat:"Bebés", temp:"todo el año", margen:60, explotado:42, proyeccion:78, tend:"subiendo", term:"婴儿背带", nota:"Nicho con comunidad fuerte." },
  { n:"Aparatos de belleza", cat:"Belleza", temp:"primavera", margen:64, explotado:72, proyeccion:66, tend:"estable", term:"美容仪", nota:"Sólo aparatos: el cosmético va con ANMAT." },
  { n:"Depilación y afeitado", cat:"Belleza", temp:"verano", margen:64, explotado:70, proyeccion:68, tend:"estable", term:"剃须刀", nota:"Voltra lo tiene entre sus más vendidos." },
  { n:"Cuidado del cabello", cat:"Belleza", temp:"primavera", margen:64, explotado:78, proyeccion:60, tend:"bajando", term:"美发工具", nota:"Saturado. Sólo herramientas, no producto." },
  { n:"Manicura", cat:"Belleza", temp:"todo el año", margen:64, explotado:66, proyeccion:64, tend:"estable", term:"美甲工具", nota:"Kit que sube el ticket. Público fiel." },
  { n:"Organización de cosméticos", cat:"Belleza", temp:"todo el año", margen:64, explotado:58, proyeccion:66, tend:"estable", term:"化妆品收纳", nota:"Cruza con Hogar. Sin certificación." },
  { n:"Accesorios de audio", cat:"Tecnología", temp:"todo el año", margen:34, explotado:85, proyeccion:56, tend:"bajando", term:"耳机配件", nota:"Márgenes apretados contra marcas." },
  { n:"Carga y energía", cat:"Tecnología", temp:"todo el año", margen:32, explotado:80, proyeccion:58, tend:"bajando", term:"充电器", nota:"Enchufa y compite con marcas." },
  { n:"Fotografía móvil", cat:"Tecnología", temp:"todo el año", margen:48, explotado:55, proyeccion:70, tend:"subiendo", term:"手机摄影", nota:"Creadores de contenido: nicho creciendo." },
  { n:"Smart home", cat:"Tecnología", temp:"todo el año", margen:44, explotado:58, proyeccion:74, tend:"subiendo", term:"智能家居", nota:"Ticket medio-alto. Todo enchufa." },
  { n:"Almacenamiento y backup", cat:"Tecnología", temp:"todo el año", margen:30, explotado:72, proyeccion:58, tend:"bajando", term:"存储设备", nota:"Difícil competir con marcas." },
  { n:"Accesorios gamer", cat:"Gaming", temp:"invierno", margen:40, explotado:70, proyeccion:66, tend:"estable", term:"电竞配件", nota:"Comunidad enorme, sensible al precio." },
  { n:"Setup gamer deco", cat:"Gaming", temp:"invierno", margen:52, explotado:60, proyeccion:72, tend:"subiendo", term:"电竞灯光", nota:"Muy visual, se vende por estética." },
  { n:"Coleccionables gaming", cat:"Gaming", temp:"todo el año", margen:42, explotado:50, proyeccion:68, tend:"subiendo", term:"游戏周边", nota:"Ojo con licencias y marcas registradas." },
  { n:"Organización de viaje", cat:"Viaje", temp:"verano", margen:54, explotado:48, proyeccion:76, tend:"subiendo", term:"旅行收纳", nota:"Compra por evento, ticket medio." },
  { n:"Valijas y bolsos", cat:"Viaje", temp:"verano", margen:46, explotado:62, proyeccion:70, tend:"estable", term:"行李箱", nota:"Voluminoso. Textil paga derechos altos." },
  { n:"Confort de vuelo", cat:"Viaje", temp:"verano", margen:62, explotado:44, proyeccion:74, tend:"subiendo", term:"旅行颈枕", nota:"Impulso previo al viaje. Buen margen." },
  { n:"Adaptadores y viaje tech", cat:"Viaje", temp:"todo el año", margen:44, explotado:58, proyeccion:66, tend:"estable", term:"转换插头", nota:"Enchufa: certificación." },
  { n:"Joyería de acero", cat:"Moda", temp:"todo el año", margen:78, explotado:82, proyeccion:62, tend:"estable", term:"钛钢首饰", nota:"Valor/peso imbatible. Ganás por curaduría." },
  { n:"Relojes", cat:"Moda", temp:"todo el año", margen:58, explotado:80, proyeccion:56, tend:"bajando", term:"手表", nota:"Ojo con réplicas: infracción marcaria." },
  { n:"Anteojos y sol", cat:"Moda", temp:"verano", margen:62, explotado:74, proyeccion:60, tend:"bajando", term:"太阳镜", nota:"Riesgo de copiar diseños registrados." },
  { n:"Billeteras y marroquinería", cat:"Moda", temp:"todo el año", margen:58, explotado:68, proyeccion:64, tend:"estable", term:"钱包", nota:"Textil y cuero pagan derechos altos." },
  { n:"Accesorios de pelo", cat:"Moda", temp:"todo el año", margen:66, explotado:64, proyeccion:60, tend:"estable", term:"发饰", nota:"Ticket bajo, sólo en packs." },
  { n:"Bufandas y abrigo", cat:"Moda", temp:"invierno", margen:66, explotado:70, proyeccion:54, tend:"bajando", term:"围巾", nota:"Estacional y con talles." },
  { n:"Juguetes educativos", cat:"Niños", temp:"otoño", margen:46, explotado:56, proyeccion:72, tend:"estable", term:"益智玩具", nota:"Certificación obligatoria de seguridad." },
  { n:"Arte y manualidades", cat:"Niños", temp:"otoño", margen:54, explotado:48, proyeccion:70, tend:"subiendo", term:"手工玩具", nota:"Recompra por consumibles." },
  { n:"Aire libre para niños", cat:"Niños", temp:"verano", margen:48, explotado:52, proyeccion:68, tend:"estable", term:"儿童户外", nota:"Estacional fuerte." },
  { n:"Organización infantil", cat:"Niños", temp:"otoño", margen:52, explotado:44, proyeccion:72, tend:"subiendo", term:"儿童收纳", nota:"Cruza con Hogar, menos competido." },
  { n:"Herramientas manuales", cat:"Herramientas", temp:"todo el año", margen:50, explotado:62, proyeccion:68, tend:"estable", term:"手动工具", nota:"Alta intención, cero devolución." },
  { n:"Medición y nivelación", cat:"Herramientas", temp:"todo el año", margen:50, explotado:50, proyeccion:72, tend:"subiendo", term:"测量工具", nota:"Público profesional que paga." },
  { n:"Organización de taller", cat:"Herramientas", temp:"todo el año", margen:50, explotado:46, proyeccion:74, tend:"subiendo", term:"工具收纳", nota:"Poco explotado en ecommerce local." },
  { n:"Seguridad y protección", cat:"Herramientas", temp:"todo el año", margen:50, explotado:44, proyeccion:70, tend:"estable", term:"劳保用品", nota:"Compra recurrente de empresas." },
  { n:"Fiesta y eventos", cat:"Eventos", temp:"todo el año", margen:62, explotado:58, proyeccion:64, tend:"estable", term:"派对用品", nota:"Muy estacional, ticket bajo." },
  { n:"Regalos personalizados", cat:"Eventos", temp:"todo el año", margen:76, explotado:42, proyeccion:80, tend:"subiendo", term:"定制礼品", nota:"Personalización = margen y difícil de copiar." },
  { n:"Bar y coctelería", cat:"Eventos", temp:"todo el año", margen:62, explotado:44, proyeccion:76, tend:"subiendo", term:"调酒工具", nota:"Ticket medio-alto, público que regala." },
  { n:"Adultos mayores", cat:"Emergentes", temp:"todo el año", margen:68, explotado:26, proyeccion:84, tend:"subiendo", term:"老人用品", nota:"Nicho enorme y muy desatendido en Argentina." },
  { n:"Accesibilidad", cat:"Emergentes", temp:"todo el año", margen:66, explotado:24, proyeccion:78, tend:"subiendo", term:"辅助器具", nota:"Muy poco explotado, alta necesidad real." },
  { n:"Home office ergonómico", cat:"Emergentes", temp:"invierno", margen:64, explotado:46, proyeccion:80, tend:"subiendo", term:"居家办公", nota:"Se consolidó, no era moda pasajera." },
  { n:"Sustentables y reutilizables", cat:"Emergentes", temp:"primavera", margen:62, explotado:36, proyeccion:76, tend:"subiendo", term:"环保用品", nota:"Tendencia sostenida, público dispuesto a pagar." },
  { n:"Organización de autos eléctricos", cat:"Emergentes", temp:"todo el año", margen:50, explotado:18, proyeccion:74, tend:"subiendo", term:"电动车配件", nota:"Muy temprano, pero crece rápido." },
  { n:"Creadores de contenido", cat:"Emergentes", temp:"todo el año", margen:52, explotado:44, proyeccion:82, tend:"subiendo", term:"直播设备", nota:"Explotando con el live commerce." },
  { n:"Otro", cat:"Otro", temp:"todo el año", margen:50, explotado:50, proyeccion:50, tend:"estable", term:"", nota:"Sin clasificar." }
];
...
/* ---------- temporadas ----------
   Argentina está en el hemisferio sur, así que lo que hoy explota en Estados
   Unidos es un adelanto de seis meses de nuestra temporada opuesta. Sirve para
   comprar antes que el resto: el stock de verano se pide en pleno invierno. */
const TEMPORADAS = ["verano","otoño","invierno","primavera"];
const MES_TEMP_SUR = ["verano","verano","otoño","otoño","otoño","invierno",
                      "invierno","invierno","primavera","primavera","primavera","verano"];
const temporadaSur = (f=new Date()) => MES_TEMP_SUR[f.getMonth()];
const temporadaNorte = (f=new Date()) => {
  const op = { verano:"invierno", invierno:"verano", otoño:"primavera", primavera:"otoño" };
  return op[temporadaSur(f)];
};
/* Qué estamos por vivir: lo que hoy arranca en el norte llega acá en 6 meses. */
const proximaTemporadaSur = (f=new Date()) => {
  const i = TEMPORADAS.indexOf(temporadaSur(f));
  return TEMPORADAS[(i+1) % 4];
};
